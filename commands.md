...
ls :List. Shows all files and directories within your current folder.
git init : Initialize. Creates a new local Git repository. It generates a hidden .git folder to start tracking changes.
